...
const cfg = {
  ...
  queueLimit: 0,
  // Force DATETIME columns to round-trip as ISO strings, not JS Date objects.
  // This is the single biggest API contract we have to keep stable.
  dateStrings: true,
  // Disable multipleStatements so callers can't sneak a `; DROP TABLE` through
  // a single query string. Every domain helper uses parameterised SQL anyway.
  multipleStatements: false,
  // utf8mb4 keeps emoji + most CJK in titles intact.
  charset: 'utf8mb4',
};
