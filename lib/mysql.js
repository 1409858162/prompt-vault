...
const DATETIME_COLUMNS = {
  ...
  user_messages: ['read_at', 'created_at', 'updated_at'],
  idea_prompts: ['created_at', 'updated_at'],
  prompt_cards: ['created_at', 'updated_at'],
  prompt_card_bodies: ['created_at', 'updated_at'],
  tutorials: ['created_at', 'updated_at'],
};
...
const BOOL_COLUMNS = {
  ...
  idea_prompts: ['active'],
  prompt_cards: ['is_free', 'is_blindbox', 'member_only', 'active'],
  tutorials: ['enabled'],
};
